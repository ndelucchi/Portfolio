...
| [Web Traffic Time Series with PySpark](https://github.com/ndelucchi/Web-Traffic-Time-Series-with-PySpark)|  PySpark, Time Series Data, Data Pipeline, MLOps,  Machine Learning  |  This project is a robust, end-to-end time series forecasting pipeline for predicting web traffic volume across thousands of distinct pages. The entire workflow—from data preprocessing and feature engineering to model training and hyperparameter tuning—was executed within a distributed computing environment using PySpark to manage the massive dataset.   | PySpark, XGBoost, pandas, numpy, matplotlib |
